package com.princeli.myhadoop.mr.kpi;
...
public class KPI {
    ...
    public static KPI filterPVs(String line) {
        ...
        pages.add("/category/english/");
        pages.add("/2016/01/");
        pages.add("/2015/08/");
        pages.add("/2015/06/");
        pages.add("/2015/05/");
        pages.add("/2015/04/");
        pages.add("/diary-of-a-wimpy-kid-02-rodrick-rules-vocabulary-ldioms/");
        pages.add("/diary-of-a-wimpy-kid-1-greg-heffleys-journal-vocabulary-ldioms/");
        pages.add("/feed/");
        pages.add("/comments/feed/");
        pages.add("/bnr-reading-notes2-objective-c-and-foundation/");
